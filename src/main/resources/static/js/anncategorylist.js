...
let url = "http://localhost:8091/rest/admin/announcement/category/datatable/list";
let tempUrl = "http://localhost:8091/rest/admin/announcement/category/datatable/list";
let searchKey = "";
...
$(document).ready(function() {
    var tablem = $('#exampleTable').DataTable({
        ...
        "columns": [
            { "data": "ann_category_title", "name": "ann_category_title", "autoWidth": true },
            {
                "data": "id", "name": "id", "autoWidth": true,
                "render": function (data) {
                    var a = `<div class="ui buttons" style="float: left">
                    <a href="http://localhost:8091/admin/announcement/category/`+data+`" class="ui vertical animated primary button">
                    ...
                    <div class="ya da"></div>
                    <button onclick="deleteAnnCategory(`+data+`)" class="ui vertical animated negative button">
