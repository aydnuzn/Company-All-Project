...
@Service
public class AnnouncementControllerBusiness {
    ...
    public String annCategoryAdd(AnnouncementCategory announcementCategory, BindingResult bindingResult, Model model) {
    ...
    public String announcementCategoryItem(String stIndex, Model model) {
        try {
    ...
    public String annCategoryUpdate(AnnouncementCategory announcementCategory, BindingResult bindingResult, String stIndex, Model model) {
    ...
    public String announcementAdd(AnnouncementInterlayer announcementInterlayer, BindingResult bindingResult, Model model) {
        if (!bindingResult.hasErrors()) {
    ...
    public String announcementItem(String stIndex, Model model) {
        try {
            Integer index = Integer.parseInt(stIndex);
    ...
    public String announcementUpdate(AnnouncementInterlayer announcementInterlayer, BindingResult bindingResult, String stIndex, Model model) {
        // Kulanıcı formdaki id yi String yaparsa diye kontrol
        Integer index = 0;
        try {
            index = Integer.parseInt(stIndex);
