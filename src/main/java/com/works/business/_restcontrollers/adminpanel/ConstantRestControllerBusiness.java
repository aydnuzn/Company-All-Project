...
@Service
public class ConstantRestControllerBusiness {
    final DistrictRepository districtRepository;
    final GalleryRepository galleryRepository;
    final GalleryImageRepository galleryImageRepository;

    public ConstantRestControllerBusiness(DistrictRepository districtRepository, GalleryRepository galleryRepository, GalleryImageRepository galleryImageRepository) {
    ...
    public Map<REnum, Object> galleryDelete(String stIndex) {
        Map<REnum, Object> hm = new LinkedHashMap<>();
        try {
    ...
    public Map<REnum, Object> galleryImageDelete(String galleryId, String imageId) {
        Map<REnum, Object> hm = new LinkedHashMap<>();
        try {
