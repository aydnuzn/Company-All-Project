...
public class AnnouncementRestController {
    ...
    public Map<REnum, Object> announcementListSearch(@RequestBody @PathVariable String stSearchKey, @PathVariable String stIndex) {
        ...
        hm.put(REnum.RESULT, announcementElasticRepository.findByAnn_title(stSearchKey, PageRequest.of(Integer.parseInt(stIndex) - 1, Util.pageSize)));
        int additional = 0;
        Integer size = announcementElasticRepository.findByAnn_title(stSearchKey).size();
