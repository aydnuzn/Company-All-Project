...
public interface AnnCategorySessionRepository extends CrudRepository<AnnCategorySession, String> {
    ...
    List<AnnCategorySession> findByCompanynameEquals(String companyname, Pageable pageable);
    List<AnnCategorySession> findByCompanynameEquals(String companyname);
}
